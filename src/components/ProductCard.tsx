    ...
    >
      ...
      <div className="flex flex-col flex-1 p-4 sm:p-5">
        ...
        <div className="space-y-2 mt-auto">
          ...
          <button
            onClick={() => onViewDetails(product)}
            className="w-full py-2 px-3 rounded-xl bg-neutral-800/70 hover:bg-neutral-800 border border-neutral-700 text-neutral-300 hover:text-white font-semibold text-xs transition-colors"
